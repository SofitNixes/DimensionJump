...
//        ((org.bukkit.craftbukkit.v1_16_R3.CraftServer)Bukkit.getServer()).getCommandMap().register(Main.getInstance().getDescription().getName(),
//                new CommandTemplate(Main.getInstance(), false) { @Override public boolean execute(CommandSender sender, String command, String[] args) { return false; } });
    ...
    @Override
    public abstract boolean execute(@Nonnull CommandSender sender, @Nonnull String command, @Nonnull String[] args);
