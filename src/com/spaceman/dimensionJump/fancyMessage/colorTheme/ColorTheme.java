...
public class ColorTheme implements ConfigurationSerializable {
        ...
        for (Object o : objects) {
            ...
            if (o == null) {
                ...
                if (textPiece.startsWith("/") && !Pattern.compile("[\\[\\]<>]").matcher(textPiece).find()) {
                    component.addTextEvent(hoverEvent(textPiece, ColorType.infoColor));
                    component.addTextEvent(ClickEvent.runCommand(textPiece));
                }
                component.setInsertion(textPiece);
    ...
    public static void sendInfoTranslation(Player player, String id, Object... objects) {
        if (player != null) formatInfoTranslation(id, objects).sendAndTranslateMessage(player);
    }
    public static void sendErrorTranslation(Player player, String id, Object... objects) {
        if (player != null) formatErrorTranslation(id, objects).sendAndTranslateMessage(player);
    }
    public static void sendSuccessTranslation(Player player, String id, Object... objects) {
