    ...
    public void run(String[] args, Player player) {
        ...
        if (args.length == 2) {
            ...
            if (lang.equals("custom")) {
                sendInfoTheme(player, "Your language is set to %s, this means that you have to use the " + Message.pluginName + " Language Resource Pack", lang);
            ...
            sendErrorTheme(player, "Usage: %s", "/" + Message.command + " language get");
        }
    }
}
